...
public class GrupoPersonal_estadisticas implements java.io.Serializable {
    ...
    public GrupoPersonal_estadisticas() {
    }

    public GrupoPersonal_estadisticas(long id, String codigo, String valor) {
        this.id = id;
        this.codigo = codigo;
        this.valor = valor;
    }
