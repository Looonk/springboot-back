...
/**
 * SolicitudCitologia generated by hbm2java
 */
@Entity
@Table(name = "solicitud_citologia", schema = "publico")
@JsonIdentityInfo(generator = ObjectIdGenerators.PropertyGenerator.class, property = "id")
public class SolicitudCitologia_estadisticas implements java.io.Serializable {
    ...
    public SolicitudCitologia_estadisticas() {
    }

    public SolicitudCitologia_estadisticas(long id,
    ...
    public SolicitudCitologia_estadisticas(long id,
                                           ...
                                           String motivoConsulta, String hallazgos, String observaciones,
                                           Long cid, long realizadoPorId, Long medicoExternoId,
                                           Date fechaLiberada, Date horaLiberada, Date fechaRechazada,
                                           Date horaRechazada, Date fechaAceptada, Date horaAceptada,
                                           String motivoRechazo, Boolean eliminado,
    ...
    @OneToMany(fetch = FetchType.LAZY, mappedBy = "solicitudCitologia")
