...
public class TipoNomina_estadisticas implements java.io.Serializable {
    ...
    public TipoNomina_estadisticas() {
    }

    public TipoNomina_estadisticas(long id, String codigo, String valor) {
        this.id = id;
        this.codigo = codigo;
        this.valor = valor;
    }
