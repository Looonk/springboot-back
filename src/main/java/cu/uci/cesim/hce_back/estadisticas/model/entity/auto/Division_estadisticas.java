...
public class Division_estadisticas implements java.io.Serializable {
    ...
    public Division_estadisticas() {
    }

    public Division_estadisticas(long id, String codigo, String valor) {
        this.id = id;
        this.codigo = codigo;
        this.valor = valor;
    }
