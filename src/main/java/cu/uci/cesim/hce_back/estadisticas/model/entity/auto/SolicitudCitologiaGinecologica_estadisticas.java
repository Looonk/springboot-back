...
/**
 * SolicitudCitologiaGinecologica generated by hbm2java
 */
@Entity
@Table(name = "solicitud_citologia_ginecologica", schema = "publico")
@JsonIdentityInfo(generator = ObjectIdGenerators.PropertyGenerator.class, property = "id")
public class SolicitudCitologiaGinecologica_estadisticas implements
    ...
    private Medico_estadisticas medicoByPatologoGuardiaId;
    ...
    private Medico_estadisticas medicoByMedicoId;
    ...
    private Boolean postparto;
    private Long cid;
    private long realizadoPorId;
    private Long medicoExternoId;
    private Long aspectoClinicoCuelloId;
    ...
    public SolicitudCitologiaGinecologica_estadisticas() {
    }

    public SolicitudCitologiaGinecologica_estadisticas(long id,
    ...
    public SolicitudCitologiaGinecologica_estadisticas(long id,
                                                       ...
                                                       Medico_estadisticas medicoByPatologoGuardiaId,
                                                       OrigenSolicitudAnatomia_estadisticas origenSolicitudAnatomia,
                                                       EstadoSolicitudAnatomia_estadisticas estadoSolicitudAnatomia,
                                                       Medico_estadisticas medicoByMedicoId, Entidad_estadisticas entidad,
                                                       Date fechaCreada, Date horaCreada, int numero,
                                                       String motivoConsulta, String hallazgos,
                                                       String tratamientoHormonal, String tratamientoRecibido,
                                                       String observaciones, Date fechaUltimaRegla, Boolean embarazada,
                                                       Integer cantidadSemanas, Boolean lactancia, Boolean postparto,
                                                       Long cid, long realizadoPorId, Long medicoExternoId,
                                                       Long aspectoClinicoCuelloId, Date fechaLiberada, Date horaLiberada,
                                                       Date fechaRechazada, Date horaRechazada, Date fechaAceptada,
                                                       Date horaAceptada, String motivoRechazo, Boolean eliminado,
                                                       Set<HojaConsulta_estadisticas> hojaConsultas) {
        this.id = id;
        this.hojaFrontal = hojaFrontal;
        this.diagnosticoMedico = diagnosticoMedico;
        this.medicoByPatologoGuardiaId = medicoByPatologoGuardiaId;
        this.origenSolicitudAnatomia = origenSolicitudAnatomia;
        this.estadoSolicitudAnatomia = estadoSolicitudAnatomia;
        this.medicoByMedicoId = medicoByMedicoId;
        ...
        this.postparto = postparto;
        this.cid = cid;
        this.realizadoPorId = realizadoPorId;
        this.medicoExternoId = medicoExternoId;
        this.aspectoClinicoCuelloId = aspectoClinicoCuelloId;
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "patologo_guardia_id")
    public Medico_estadisticas getMedicoByPatologoGuardiaId() {
        return this.medicoByPatologoGuardiaId;
    }

    public void setMedicoByPatologoGuardiaId(
            Medico_estadisticas medicoByPatologoGuardiaId) {
        this.medicoByPatologoGuardiaId = medicoByPatologoGuardiaId;
    }
    ...
    public Medico_estadisticas getMedicoByMedicoId() {
        return this.medicoByMedicoId;
    }

    public void setMedicoByMedicoId(Medico_estadisticas medicoByMedicoId) {
        this.medicoByMedicoId = medicoByMedicoId;
    }
    ...
    @Column(name = "tratamiento_recibido")
    ...
    public void setTratamientoRecibido(String tratamientoRecibido) {
        if (tratamientoRecibido != null)
            tratamientoRecibido = tratamientoRecibido.trim();
        this.tratamientoRecibido = tratamientoRecibido;
    }
    ...
    @Temporal(TemporalType.DATE)
    @Column(name = "fecha_ultima_regla", length = 13)
    ...
    @Column(name = "postparto")
    public Boolean getPostparto() {
        return this.postparto;
    }

    public void setPostparto(Boolean postparto) {
        this.postparto = postparto;
    }
    ...
    @Column(name = "aspecto_clinico_cuello_id")
    public Long getAspectoClinicoCuelloId() {
        return this.aspectoClinicoCuelloId;
    }

    public void setAspectoClinicoCuelloId(Long aspectoClinicoCuelloId) {
        this.aspectoClinicoCuelloId = aspectoClinicoCuelloId;
    }
    ...
    @OneToMany(fetch = FetchType.LAZY, mappedBy = "solicitudCitologiaGinecologica")
