...
public class SubdivisionPersonal_estadisticas implements java.io.Serializable {
    ...
    private Set<PersonaHist_estadisticas> personaHists = new HashSet<PersonaHist_estadisticas>(
            0);
    private Set<DatosLaborales_estadisticas> datosLaborales = new HashSet<DatosLaborales_estadisticas>(
            0);

    public SubdivisionPersonal_estadisticas() {
    }

    public SubdivisionPersonal_estadisticas(long id, String codigo, String valor) {
        this.id = id;
        this.codigo = codigo;
        this.valor = valor;
    }
    ...
    public SubdivisionPersonal_estadisticas(
            ...
            Set<DatosLaborales_estadisticas> datosLaborales) {
        this.id = id;
        this.codigo = codigo;
        this.valor = valor;
    ...
    public Set<DatosLaborales_estadisticas> getDatosLaborales() {
        return this.datosLaborales;
    }

    public void setDatosLaborales(Set<DatosLaborales_estadisticas> datosLaborales) {
        this.datosLaborales = datosLaborales;
    }
